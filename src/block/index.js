...
const EXTENSION_ID = 'posenet2scratch';
 ...
 * @type {string}
 */
let extensionURL = 'https://champierre.github.io/xcx-posenet2scratch/dist/posenet2scratch.mjs';
...
class ExtensionBlocks {
    ...
    /**
     * Construct a set of blocks for PoseNet2Scratch.
...
const extensionTranslations = {
    'ja': {
        'posenet2scratch.doIt': '[SCRIPT] を実行する'
    },
    'ja-Hira': {
        'posenet2scratch.doIt': '[SCRIPT] をじっこうする'
    }
};
